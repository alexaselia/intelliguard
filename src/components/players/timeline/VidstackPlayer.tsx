// components/players/timeline/VidstackPlayer.tsx
...
export const VidstackPlayer: React.FC<VidstackPlayerProps> = ({ videoUrl, currentTime, onTimeUpdate, isLive, onEnded, thumbnails }) => {
  ...
  return (
    <MediaPlayer
      ...
      aspectRatio="16/9"
      onEnded={onEnded}
      style={{ maxWidth: '100%', maxHeight: '100%', overflow: 'hidden' }} // Ensure no zoom
    >
      <MediaProvider>
        <Poster
        ...
        {thumbnails?.map((thumb) => (
          <Track key={thumb} kind="metadata" src={thumb} />
        ))}
      </MediaProvider>
